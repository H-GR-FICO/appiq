...
window.I18n = (function () {
  ...
  var _T = {
    ...
    cs: {
      ...
      // ── Version Selector (GitHub Pages root) ──
      'vs.tag':           'VYDANÉ VERZE',
      'vs.subtitle':      'AI-powered Enterprise Application Platform',
      'vs.current':       'Aktuální verze',
      'vs.archived':      'Archivované verze',
      'vs.loading':       'Načítám verze…',
      'vs.error':         'Nelze načíst versions.json',
      'vs.btn.prez':      'Prezentace',
    ...
    en: {
      ...
      // ── Version Selector (GitHub Pages root) ──
      'vs.tag':           'PUBLISHED VERSIONS',
      'vs.subtitle':      'AI-powered Enterprise Application Platform',
      'vs.current':       'Latest version',
      'vs.archived':      'Archived versions',
      'vs.loading':       'Loading versions…',
      'vs.error':         'Cannot load versions.json',
      'vs.btn.prez':      'Presentation',
      'vs.btn.hub':       'Studio Hub',
      'vs.btn.pitch':     'Personal Pitch',
      'vs.btn.docs':      'Docs',
