...
window.COCKPIT_SECTIONS = [
  ...
  { num:'29', icon:'🎓', name:{cs:'AI Training Center',          en:'AI Training Center'},
    desc:{cs:'Interaktivní vzdělávací centrum — AI foundation, HOPI kontext, ekosystém, scénáře nasazení.',
          en:'Interactive learning hub — AI foundation, HOPI context, ecosystem, deployment scenarios.'},
    url:'training-center.html', color:'violet' },
];
